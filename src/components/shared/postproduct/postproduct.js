...
import { get } from '../../../helpers/api'; /*required a view*/

class postproduct extends React.Component {
  componentDidMount() {
    if (!this.props.productList.length) {
      this.props.Products();
      this.props.getCategories(); /**no se si lo necesito */
    }
        ...
        <div className="newProduct-container">
          <Formik
            ...
            onSubmit={(values, { setSubmitting }) => {
              this.props.product(values).then(res => {
                if (res.type === 'POST_PRODUCT_FULFILLED') {
            ...
            {({
              ...
              <form onSubmit={handleSubmit} className="post-product-form">
                ...
                >
                  ...
                  <MenuItem value={product.category.name}></MenuItem>
                </Select>
